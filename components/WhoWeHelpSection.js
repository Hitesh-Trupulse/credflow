  ...
  return (
    <section id="who-we-help" className="scroll-mt-32 bg-black py-20 text-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p data-aos="fade-down" className="text-gray-300 max-w-2xl mx-auto mb-16">
          ...
          {cards.map((card, i) => (
            ...
            >
              {i === 1 || i === 0 ? (
                <div
                  data-aos="zoom-in"
                  className="absolute hidden lg:block top-1/4 right-0 w-px h-1/2 bg-gradient-to-b from-purple-500/30 to-blue-500/30"
                />
              ) : null}
              ...
              {i === 4 || i === 5 ? (
                <div
                  data-aos="zoom-in"
                  className="hidden lg:block absolute top-1/4 left-0 w-px h-1/2 bg-gradient-to-b from-blue-500/30 to-emerald-500/30"
                />
              ) : null}
              ...
              >
                <Clock className="w-7 h-7 text-gray-300" aria-hidden="true" />
              </div>
