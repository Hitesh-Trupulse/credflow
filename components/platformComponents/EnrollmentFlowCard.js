...
export default function EnrollmentFlowCard() {
  ...
  return (
    <div className="backdrop-blur-xl bg-black/60 border border-gray-600 text-white rounded-xl sm:rounded-2xl p-2 sm:p-3 md:p-4 lg:p-6 shadow-lg w-full md:h-[310px] md:max-w-xs lg:max-w-sm mx-auto">
      {/* Header */}
