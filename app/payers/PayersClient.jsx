    ...
    <>
      <div className="min-h-screen bg-black">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <div data-aos="fade-up" className="flex flex-wrap gap-2 justify-center lg:justify-start">
                  <span className="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-b from-white/10 to-black/50 backdrop-blur-sm border border-[#454545] text-white">CredFlow Advantage</span>
                  <span className="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-b from-white/10 to-black/50 backdrop-blur-sm border border-[#454545] text-white">Marketplace CHP</span>
                  <span className="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-b from-white/10 to-black/50 backdrop-blur-sm border border-[#454545] text-white">Medicaid</span>
                  <span className="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-b from-white/10 to-black/50 backdrop-blur-sm border border-[#454545] text-white">Commercial</span>
                </div>
              </div>
              
              {/* Audit Snapshot Card */}
              <div data-aos="zoom-in" className="relative">
                <div className="absolute -inset-4 rounded-3xl bg-gradient-to-r from-[#5063C6]/20 to-[#B71CD2]/20 blur-2xl max-w-md mx-auto lg:ml-auto" />
                <div className="relative bg-black/85 backdrop-blur-sm border border-[#454545] rounded-3xl p-6 max-w-md mx-auto lg:ml-auto shadow-2xl">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-base font-medium text-white">Directory Audit Snapshot</h3>
                    <span className="px-2 py-1 bg-white/10 text-white text-sm rounded-full font-medium border border-[#454545]">Live</span>
                  </div>
                  
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    <div className="text-center p-3 bg-black/60 backdrop-blur-sm border border-[#454545] rounded-2xl">
                      <div className="text-2xl font-bold text-white">847</div>
                      <div className="text-sm text-gray-500">In-network verified</div>
                    </div>
                    <div className="text-center p-3 bg-black/60 backdrop-blur-sm border border-[#454545] rounded-2xl">
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center gap-3 text-base rounded-2xl border border-[#454545] bg-gradient-to-r from-white/[0.05] to-transparent p-3">
                  ...
                  <button className="w-full flex items-center justify-center gap-2 px-3 py-3 bg-gradient-to-r from-[#5063C6] to-[#B71CD2] rounded-full border border-transparent hover:opacity-90 transition-opacity">
                    <CheckCircle className="w-4 h-4 text-white" />
                    <span className="text-base text-white font-medium">Attestation ready report</span>
                  </button>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 md:py-32 bg-black">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 data-aos="fade-down" className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6 leading-tight">
            ...
            <div data-aos="fade-up" className="flex flex-wrap gap-3 justify-center mb-12">
              <span className="px-4 py-2 rounded-full text-base font-medium bg-gradient-to-b from-white/[0.06] to-black backdrop-blur-sm border border-[#454545] text-red-400 flex items-center">
            ...
            <div data-aos="fade-up" className="max-w-md mx-auto">
              <div className="text-center mb-3">
                <span className="text-base font-medium text-gray-500">Compliance Posture</span>
              </div>
              <div className="relative h-3 bg-gray-900/50 border border-[#454545] rounded-full overflow-hidden">
        ...
        <section className="py-20 md:py-32 bg-black">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div data-aos="fade-up" className="bg-gradient-to-b from-white/[0.04] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-8 text-center hover:border-[#5063C6] transition-colors duration-300">
                ...
                <h3 className="text-2xl font-light text-white mb-3">Accuracy</h3>
              ...
              <div data-aos="fade-up" className="bg-gradient-to-b from-white/[0.04] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-8 text-center hover:border-[#5063C6] transition-colors duration-300">
                ...
                <h3 className="text-2xl font-light text-white mb-3">Speed</h3>
                <p className="text-gray-400 text-base leading-relaxed">
              ...
              <div data-aos="fade-up" className="bg-gradient-to-b from-white/[0.04] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-8 text-center hover:border-[#5063C6] transition-colors duration-300">
                ...
                <h3 className="text-2xl font-light text-white mb-3">Defensibility</h3>
                <p className="text-gray-400 text-base leading-relaxed">
        ...
        <section className="py-20 md:py-32 bg-black">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center mb-16">
              <h2 data-aos="fade-down" className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-4 leading-tight">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-8">
              {[
                ...
                <div key={step.title} className="relative">
                  <div data-aos="fade-up" className="bg-gradient-to-b from-white/[0.04] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-6 text-center h-full hover:border-[#5063C6] transition-colors duration-300">
                  ...
                  {index < 3 && (
                    <div className="hidden md:flex absolute top-1/2 -right-3 translate-x-1/2 -translate-y-1/2 z-10 h-8 w-8 items-center justify-center rounded-full border border-[#454545] bg-black">
            ...
            <p data-aos="fade-up" className="text-center text-base text-gray-500">
        ...
        <section className="py-20 md:py-32 bg-black">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <Tabs defaultValue="nsa" className="max-w-4xl mx-auto">
              <TabsList className="grid w-full grid-cols-3 mb-8 bg-gradient-to-b from-white/[0.06] to-black backdrop-blur-sm border border-[#454545] p-1 rounded-2xl">
              ...
              <TabsContent value="nsa" className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div data-aos="fade-up" className="bg-gradient-to-b from-white/[0.04] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-6">
                ...
                <div data-aos="fade-up" className="bg-gradient-to-b from-white/[0.04] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button className="px-4 py-2 rounded-full text-base font-medium bg-black/60 backdrop-blur-sm border border-[#454545] text-white hover:border-[#5063C6] transition-colors">Reporting with timestamps</button>
                    <button className="px-4 py-2 rounded-full text-base font-medium bg-black/60 backdrop-blur-sm border border-[#454545] text-white hover:border-[#5063C6] transition-colors">Verification per provider (NPI)</button>
                    <button className="px-4 py-2 rounded-full text-base font-medium bg-black/60 backdrop-blur-sm border border-[#454545] text-white hover:border-[#5063C6] transition-colors">Compliance attestation (annual)</button>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="cms" className="space-y-6">
                <div data-aos="fade-up" className="bg-gradient-to-b from-white/[0.04] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-6">
                  ...
                  <p className="text-base text-gray-500 border-t border-[#454545] pt-4 leading-relaxed">
              ...
              <TabsContent value="state" className="space-y-6">
                <div data-aos="fade-up" className="bg-gradient-to-b from-white/[0.04] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-6 mb-6">
                  <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between mb-6">
                    <div>
                      <h4 className="font-semibold text-white mb-1">Select a state</h4>
                      <p className="text-base text-gray-400">State rules vary. CredFlow helps you operationalize ongoing accuracy programs.</p>
                    </div>
                    <Select value={selectedState} onValueChange={setSelectedState}>
                      <SelectTrigger className="w-40 bg-black border-[#454545]">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {states.map((state) => (
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-sm font-medium backdrop-blur-sm border transition-colors cursor-pointer ${
                          selectedState === state 
        ...
        <section className="py-20 md:py-32 bg-black">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="max-w-3xl mx-auto">
              <div data-aos="fade-up" className="bg-gradient-to-br from-[#101010] to-black backdrop-blur-sm border border-[#454545] rounded-2xl p-6 shadow-[0_0_40px_rgba(80,99,198,0.12)]">
                <div className="grid md:grid-cols-3 gap-6 text-center">
                  <button className="text-left hover:opacity-80 transition-opacity">
                    ...
                    <div className="text-base text-gray-400 hover:text-white transition-colors">Time to identify issues</div>
                  </button>
                  <button className="text-left hover:opacity-80 transition-opacity">
                    <div className="text-2xl font-bold text-white mb-1">____</div>
                    <div className="text-base text-gray-400 hover:text-white transition-colors">Time to remediate</div>
                  </button>
                  <button className="text-left hover:opacity-80 transition-opacity">
                    <div className="text-2xl font-bold text-white mb-1">____</div>
                    <div className="text-base text-gray-400 hover:text-white transition-colors">View the highest risk findings</div>
                  </button>
                </div>
                <p className="text-center text-sm text-gray-500 mt-4 pt-4 border-t border-[#454545]">
