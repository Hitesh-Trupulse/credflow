        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a 
                href="#demo-form" 
                data-cta-id="get-started-nav-book-call"
            ...
            <div className="md:hidden">
              <a 
                href="#demo-form" 
                data-cta-id="get-started-mobile-nav-book-call"
      ...
      <section id="who-we-help" className="py-24 bg-slate-900 border-y border-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          <div className="mt-12">
            <a
              href="#demo-form"
              data-cta-id="get-started-who-we-help-book-call"
      ...
      <section className="py-20 bg-slate-900 text-center relative overflow-hidden border-t border-slate-800">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <div className="flex justify-center">
            <a
              href="#demo-form"
              data-cta-id="get-started-footer-book-call"
