    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center p-10">
          ...
          <Link
            href="/resources"
            data-cta-id="resources-view-all"
            data-cta-location="resources-not-found"
            className="inline-block bg-gradient-to-r from-[#5063C6] to-[#B71CD2] text-white px-6 py-3 rounded-lg hover:opacity-90 transition-opacity"
          >
            View All Resources
          </Link>
        </div>
